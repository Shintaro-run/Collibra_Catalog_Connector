...
const STRINGS = {
  en: {
    ...
    views: {
      ...
      folder: { title: 'Folder view', desc: 'Browse a SharePoint folder tree and tag files with library metadata.' },
    },
    pipeline: {
    ...
    folderView: {
      title: 'Folder view',
      kicker: 'SharePoint library',
      lede:
        'Browse a configured SharePoint document library, see what each file is, and tag it with library metadata. Edits write back to the library item; permissions follow the user’s SharePoint group.',
      treeHeader: 'Tree',
      detailHeader: 'File detail',
      empty: 'Pick a file in the tree to view and edit its metadata.',
      readOnly: 'You have read-only access to this library.',
      meta: {
        modified: 'Modified',
    ...
    inbox: {
      ...
      lede:
        'Access requests for catalogued assets. The data steward is the single point of contact and owns the decision; the data owner is shown for reference and consultation.',
      stats: {
        pending: 'Pending',
        approved: 'Approved',
        rejected: 'Rejected',
      ...
      filters: {
        ...
        rejected: 'Rejected',
        needsInfo: 'Needs info',
        search: 'Search by asset, requester, steward, owner, or reason…',
      },
      table: {
        requester: 'Requester',
        asset: 'Asset',
      ...
      detail: {
        ...
        decisionNotePlaceholder: 'Add context for the requester…',
        approve: 'Approve',
        reject: 'Reject',
      ...
      sharepointNote:
        'When deployed to SharePoint, requests are stored in the AccessRequests List. Concurrent edits use last-write-wins; refresh to see other reviewers’ actions.',
      forbidden: {
        title: 'Access restricted',
        body: 'The request inbox is reserved for the Data Stewards group. If you should have access, ask the catalog administrator to add you.',
      },
    },
  },
  ja: {
    ...
    views: {
      ...
      folder: { title: 'フォルダービュー', desc: 'SharePoint フォルダーツリーを表示し、ライブラリメタデータを付与。' },
    },
    pipeline: {
      title: '治験パイプライン',
    ...
    folderView: {
      title: 'フォルダービュー',
      kicker: 'SharePoint ライブラリ',
      lede:
        '指定の SharePoint ドキュメントライブラリを参照し、各ファイルにライブラリメタデータを付与します。編集はライブラリ項目へ書き戻されます (権限は SharePoint グループに準拠)。',
      treeHeader: 'ツリー',
      detailHeader: 'ファイル詳細',
      empty: 'ツリーからファイルを選択するとメタデータを編集できます。',
      readOnly: 'このライブラリは読み取り専用です。',
      meta: {
        modified: '更新日時',
        modifiedBy: '更新者',
        size: 'サイズ',
    ...
    inbox: {
      ...
      kicker: 'ガバナンス・ワークフロー',
      lede:
        'カタログ対象アセットへのアクセス申請。受付・判定はデータスチュワードが行います (Single Point of Contact)。データオーナーは参考・相談先として併記されます。',
      stats: {
        pending: '審査待ち',
        approved: '承認済',
        rejected: '却下',
      ...
      filters: {
        ...
        rejected: '却下',
        needsInfo: '追加情報',
        search: 'アセット・申請者・スチュワード・オーナー・理由で検索…',
      },
      table: {
        requester: '申請者',
        asset: 'アセット',
      ...
      detail: {
        ...
        reason: '申請理由',
        intendedUse: '利用目的',
        decisionNote: '判定コメント (任意)',
        decisionNotePlaceholder: '申請者へのコメントを記載…',
        approve: '承認',
        reject: '却下',
        needsInfo: '追加情報を依頼',
        decidedBy: '判定者',
      ...
      sharepointNote:
        'SharePoint デプロイ時は AccessRequests リストへ保存されます。同時編集は last-write-wins。他レビュワーの操作はリロードで反映されます。',
      forbidden: {
        title: 'アクセスが制限されています',
        body: 'インボックスは Data Stewards グループに所属するユーザーのみが閲覧できます。アクセスが必要な場合はカタログ管理者にご連絡ください。',
      },
    },
  },
};
