...
const STRINGS = {
  en: {
    ...
    folderView: {
      ...
      writeBack: {
        bannerTitle: 'Unsaved changes for SharePoint',
        bannerSummary: '{cols} new columns · {files} files changed',
  ...
  ja: {
    ...
    folderView: {
      ...
      columns: {
        ...
        choices: '選択肢',
        choicesHint: '1 行につき 1 つの選択肢を入力。',
        required: '必須',
        submit: '列を追加',
        cancel: 'キャンセル',
      },
      writeBack: {
        bannerTitle: 'SharePoint へ未反映の変更があります',
        bannerSummary: '新規列 {cols} 件・変更ファイル {files} 件',
        goToSettings: '設定へ',
      },
      yes: 'はい',
      no: 'いいえ',
